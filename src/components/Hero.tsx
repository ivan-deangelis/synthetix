        ...
        const interval = setInterval(() => {
            setStats((prev) => {
                ...
                const newTransactions =
                    prev.transactions >= 1500000
                        ? 1500000
                        : prev.transactions + 37500;
                const newNetworks =
                    prev.networks >= 40 ? 40 : prev.networks + 1;
        ...
        <HeroBg>
            <div className="fadein-blur relative z-0 mx-auto mb-10 h-[300px] w-[300px] lg:absolute lg:top-1/2 lg:right-1/2 lg:mx-0 lg:mb-0 lg:h-[500px] lg:w-[500px] lg:translate-x-1/2 lg:-translate-y-2/3">
                ...
                <motion.div
                    ...
                    className="absolute top-4 -left-4 rounded-lg border border-purple-500/30 bg-black/80 p-2 backdrop-blur-md lg:top-1/4 lg:-left-10"
                >
                ...
                <motion.div
                    variants={tooltipVariants}
                    className="absolute top-1/2 -right-2 rounded-lg border border-blue-500/30 bg-black/80 p-2 backdrop-blur-md lg:-right-8"
                >
                    <div className="flex items-center gap-2">
            ...
            >
                <motion.div className="flex w-full flex-col items-center justify-between lg:flex-row lg:items-start">
                    ...
                    <div className="mt-6 flex flex-col items-center lg:mt-0 lg:items-end">
                        ...
                        >
                            Synthetix is a platform that allows you to create
                            mock APIs for your needs, leveraging the power of AI
