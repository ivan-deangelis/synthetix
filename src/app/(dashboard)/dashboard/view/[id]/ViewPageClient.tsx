    ...
    generateMockData: (schema: any, count: number = 1) => {
        ...
        try {
            ...
            if (schemaData.type === "object" && schemaData.fields) {
                ...
                return count === 1 && Array.isArray(records)
                    ? records[0]
                    : records;
            }
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            This will create a private copy in
                                            your workspace. The original will
                                            not be modified.
                                        </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                                        ...
                                        <AlertDialogAction
                                            onClick={async () => {
                                                ...
                                                if (
                                                    ...
                                                    const newId = (res as any)
                                                        .data as string;
                                                    router.push(
                                                        `/dashboard/edit/${newId}`
                                                    );
                                                }
                                            }}
                                        >
                            ...
                            <CardContent>
                                ...
                                typeof apiSet.schema === "object" ? (
                                    <div className="space-y-3">
                                        {Object.keys(apiSet.schema).map(
                                            (fieldName) => {
                                                const field = (
                                                    apiSet.schema as any
                                                )[fieldName];
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xs text-muted-foreground">
                                        Use <code>?count=</code> to return
                                        multiple records (max 20)
                                    </span>
                                </div>
                            </div>
